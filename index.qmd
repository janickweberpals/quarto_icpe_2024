...
[![Side-by-side example of a Quarto document (left) and a rendered .html output](images/quarto-hello.png){#fig-quarto-side-by-side .hidden width="613"}](https://quarto.org/docs/get-started/hello/rstudio.html)
