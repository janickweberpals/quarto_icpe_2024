...
[![Side-by-side example of a Quarto document (left) and a rendered .html output](images/quarto-hello.png){width="613"}](https://quarto.org/docs/get-started/hello/rstudio.html)
