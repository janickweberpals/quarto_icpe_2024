...
![](images/nature_reproducibility_crisis.jpg){#fig-nature fig-align="center"}
...
[![Side-by-side example of a Quarto document (left) and a rendered .html output](images/quarto-hello.png)](https://quarto.org/docs/get-started/hello/rstudio.html)
...
::: columns
::: {.column width="50%"}
![RStudio built-in reference manager](images/citation_manager.png)
:::
...
-   Has all capabilities of common reporting systems (e.g., MS Word) and some that go beyond (inline coding, dynamic elements, ...)
:::
